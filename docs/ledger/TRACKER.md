...
|---|---|---|
| 2026-05-23 | PR [#25](https://github.com/dynolabs-io/vcard/pull/25) merged (`bcd414b9`): **Maestro flow `11-inbox-signed-out.yaml`** — extends iOS CI coverage to V09 Inbox tab signed-out state (4 visible-asserts + screenshot). iOS CI run [26333146597](https://github.com/dynolabs-io/vcard/actions/runs/26333146597) in flight to validate. | TBD-V10 diagnostic comment posted on issue #19; CI gate added |
